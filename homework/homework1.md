...
#### Шаг 1
Пример создания проекта Django в IDE Pycharm можно просмотреть по данной [ссылке](https://github.com/iu5git/web-2022/blob/main/tutorials/lab1-py/lab1_tutorial.md).
#### Шаг 2
